...
sadmin_title('Dashboard<a href="phpix-manage.php?page=operations&method=nocache&file='.$filenm.'" class="pull-right btn btn-warning"><i class="fa fa-refresh"></i> Refresh</a><div class="clearfix"></div>'); 
include('phpix-info.php');
?>
<div class="clearfix"></div>
...
$xlinks = '<a id="delete-cache" class="confirm btn btn-xs btn-danger" href="'.$admin_url.'operations&method=delete&dir='.$row['id'].'">Delete</a>
...
<a target="_blank" href="http://phploaded.com/post/phpix-docs.html">
<div class="panel-footer">
